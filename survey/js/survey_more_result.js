...
function surveySetQuantityClick(type) {
  ...
  setTimeout(function () {
    survey_jQuery(".result-wrap .total-price-wrap .price").text(surveyComma(Number(survey_product_resource.shampoo.discountprice.mobile_discount_price)) + "원");
  }, 400);
}
