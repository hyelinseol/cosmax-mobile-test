...
function setSurveyOSDL(params) {
  ...
  if (params.osdl_result.osdl.scalp == "O") {
    ...
    survey_jQuery("#survey_scalp_image").attr(
      "src",
      "https://ecimg.cafe24img.com/pg115b69008946048/cosmaxtest/web/upload/mynomy/kr/prd/ob.png"
    );
    ...
    survey_jQuery("#survey_scalp_image").attr(
      "src",
      "https://ecimg.cafe24img.com/pg115b69008946048/cosmaxtest/web/upload/mynomy/kr/prd/nb.png"
    );
  } else {
    ...
    survey_jQuery("#survey_scalp_image").attr(
      "src",
      "https://ecimg.cafe24img.com/pg115b69008946048/cosmaxtest/web/upload/mynomy/kr/prd/db.png"
    );
  }
  ...
  if (params.osdl_result.osdl.sensitive == "S") {
    ...
    survey_jQuery("#survey_sensitive_image").attr(
      "src",
      "https://ecimg.cafe24img.com/pg115b69008946048/cosmaxtest/web/upload/mynomy/kr/prd/sb.png"
    );
  } else {
    ...
    survey_jQuery("#survey_sensitive_image").attr(
      "src",
      "https://ecimg.cafe24img.com/pg115b69008946048/cosmaxtest/web/upload/mynomy/kr/prd/rb.png"
    );
  }
  ...
  if (params.osdl_result.osdl.hair == "H") {
    ...
    survey_jQuery("#survey_hair_image").attr(
      "src",
      "https://ecimg.cafe24img.com/pg115b69008946048/cosmaxtest/web/upload/mynomy/kr/prd/hb.png"
    );
    ...
    survey_jQuery("#survey_hair_image").attr(
      "src",
      "https://ecimg.cafe24img.com/pg115b69008946048/cosmaxtest/web/upload/mynomy/kr/prd/eb.png"
    );
  }
  ...
  if (params.osdl_result.osdl.hair_loss == "L") {
    ...
    survey_jQuery("#survey_hair_loss_image").attr(
      "src",
      "https://ecimg.cafe24img.com/pg115b69008946048/cosmaxtest/web/upload/mynomy/kr/prd/lb.png"
    );
  } else {
    ...
    survey_jQuery("#survey_hair_loss_image").attr(
      "src",
      "https://ecimg.cafe24img.com/pg115b69008946048/cosmaxtest/web/upload/mynomy/kr/prd/wb.png"
    );
  }
  ...
  let sensitive_list = [];
  if (params.osdl_result.osdl.sensitive == "S") {
    survey_jQuery("#survey_sensitive_type").html(
  ...
  if (params.osdl_result.osdl.hair_loss == "L") {
    ...
    survey_jQuery("#survey_hair_loss_type").html(
      '<strong class="">탈모아니</strong>라면?'
    );
    hair_loss_list = params.osdl_result.point4.hair_tip.hair_loss;
  }
...
function setSurveySubDiagnosis(sub_survey_target, params, survey_worry_array) {
  ...
  for (let ampoule of params.osdl_result.point2.ampoules) {
    ...
    if (ampoule_name_array > 1) {
      sub_ampoule_name_html = "<p>" + ampoule_name_array[1] + "</p>";
    }
    ...
    let set_html = `
    <li class="swiper-slide item box${ampoule.sequence}">
      <div class="txt">
        <h4>${ampoule_name}</h4>
        ${sub_ampoule_name_html}
        <figure>
            <img src="//ecimg.cafe24img.com/pg115b69008946048/cosmaxtest/web/upload/mynomy/kr_mobile/prd/ampoule01.png"
                alt="앰플이미지01" />
            <p>${surveyEnterBr(ampoule.description)}</p>
        </figure>
      </div>
      <div class="comp_wrap">
        ${ingredient_html}
...
async function getSurveyBoms() {
  ...
  for (const survey_ingredient of survey_ingredient_list) {
    if (survey_ingredients.indexOf(survey_ingredient.RAWCDK) == -1) {
      survey_ingredients.push(survey_ingredient.RAWCDK);
    }
  }
  let survey_ingredient_text = survey_ingredients.join(", ");
  if (survey_ingredient_text) {
    survey_jQuery(".survey_ingredients").text(survey_ingredient_text);
  }
}
